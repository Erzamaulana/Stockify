...
<div class="container mx-auto py-8 mt-14">
    ...
    <!-- Judul Halaman -->
    <h1 class="text-3xl font-bold text-gray-900 mb-6">Edit Produk</h1>

    <!-- Form Edit Produk -->
    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input type="text" id="name" name="name" class="w-full border rounded p-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ old('name', $product->name) }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="sku" name="sku" class="w-full border rounded p-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ old('sku', $product->sku) }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="purchase_price" name="purchase_price" class="w-full border rounded p-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ old('purchase_price', $product->purchase_price) }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="selling_price" name="selling_price" class="w-full border rounded p-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ old('selling_price', $product->selling_price) }}">
        ...
        <div class="mb-4">
            ...
            <textarea id="description" name="description" class="w-full border rounded p-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('description', $product->description) }}</textarea>
        </div>
        ...
        <div class="mb-4">
            ...
            @if($product->image)
            <img src="{{ asset('storage/' . $product->image) }}" alt="Produk" class="w-32 mt-2">
            @endif
        ...
        <div class="mb-6">
            ...
            <input type="number" id="stock" name="stock" class="w-full border rounded p-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ old('stock', $product->stock) }}">
