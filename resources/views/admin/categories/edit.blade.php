...
<div class="container mx-auto p-6 mt-14">
    ...
    <!-- Judul Halaman -->
    <h1 class="text-3xl font-bold text-gray-900  mb-6">Edit Kategori Produk</h1>
    <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        @csrf
        @method('PUT')
        <div class="mb-4">
