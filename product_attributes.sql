...
-- membuang struktur untuk table stockify.product_attributes
...
-- Membuang data untuk tabel stockify.product_attributes: ~1 rows (lebih kurang)
INSERT INTO `product_attributes` (`id`, `product_id`, `name`, `value`, `created_at`, `updated_at`) VALUES
	(3, 1, 'Kadaluarsa', '2 januari 2027', '2025-02-12 23:47:07', '2025-02-12 23:47:07');
